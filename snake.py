...
# width=800
# height=800
# gameDisplay=pygame.Display.set_mode((width))
...
#     randomX = round(random.randrange(0,width-blockSize)/10) *10
#     randomY = round(random.randrange(0,height-blockSize)/10)*10
...
#             message("Game over,press c to play agaain or Q to quit ",black)
